...
lyr_wakecemeteries1_2.set('fieldAliases', {'Cemetery#': 'Cemetery#', 'Cemetery Name': 'Cemetery Name', 'Township': 'Township', 'Notes': 'Notes', 'Original Directions': 'Original Directions', 'GPS': 'GPS', 'Find a Grave': 'Find a Grave', 'Cemetery Census': 'Cemetery Census', 'Other': 'Other', 'Township#': 'Township#', 'new index url': 'new index url', 'latitude': 'latitude', 'longitude': 'longitude', '1978 Survey': '1978 Survey', });
lyr_Townships_1.set('fieldImages', {'OBJECTID': 'Range', 'FTR_CODE': 'Range', 'TOWNSHIP': 'Range', 'NAME': 'TextEdit', });
lyr_wakecemeteries1_2.set('fieldImages', {'Cemetery#': 'TextEdit', 'Cemetery Name': 'TextEdit', 'Township': 'TextEdit', 'Notes': 'TextEdit', 'Original Directions': 'TextEdit', 'GPS': 'TextEdit', 'Find a Grave': 'TextEdit', 'Cemetery Census': 'TextEdit', 'Other': 'TextEdit', 'Township#': 'TextEdit', 'new index url': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', '1978 Survey': 'TextEdit', });
lyr_Townships_1.set('fieldLabels', {'OBJECTID': 'hidden field', 'FTR_CODE': 'hidden field', 'TOWNSHIP': 'hidden field', 'NAME': 'hidden field', });
lyr_wakecemeteries1_2.set('fieldLabels', {'Cemetery#': 'hidden field', 'Cemetery Name': 'header label - visible with data', 'Township': 'hidden field', 'Notes': 'hidden field', 'Original Directions': 'inline label - visible with data', 'GPS': 'hidden field', 'Find a Grave': 'inline label - visible with data', 'Cemetery Census': 'hidden field', 'Other': 'hidden field', 'Township#': 'hidden field', 'new index url': 'hidden field', 'latitude': 'hidden field', 'longitude': 'hidden field', '1978 Survey': 'inline label - visible with data', });
